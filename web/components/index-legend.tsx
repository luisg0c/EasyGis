...
const NDVI_GUIDE: { range: string; meaning: string; tone: string }[] = [
  { range: '< 0',     meaning: 'Água, solo nu',                tone: 'text-stone' },
  { range: '0,0–0,2', meaning: 'Vegetação esparsa',            tone: 'text-clay' },
  { range: '0,2–0,4', meaning: 'Vegetação moderada',           tone: 'text-amber' },
  { range: '0,4–0,6', meaning: 'Vegetação saudável',           tone: 'text-moss-600' },
  { range: '> 0,6',   meaning: 'Vegetação muito saudável',     tone: 'text-moss-900' },
];
  ...
  return (
    <div className="border border-moss-100 bg-cream">
      ...
      <div className="px-4 py-3.5">
        <p className="editorial-num mb-2">— Escala de Cores</p>
      ...
      {indexType === 'NDVI' && (
        <div className="border-t border-moss-100 px-4 py-3.5">
          <p className="editorial-num mb-2">— Interpretação</p>
