...
\begin{itemize}
  \item[\checkmark] Todos os 54 casos de teste foram executados
  ...
  \item[\checkmark] Suite executa em $< 30$\,s \textbf{(atingido: 1{,}20\,s sem cobertura; 2{,}73\,s com cobertura)}
\end{itemize}
\end{successbox}
