...
O \textbf{EasyGis} é uma plataforma web que mostra como está a \textbf{saúde da sua plantação} usando imagens de satélite gratuitas (Sentinel-2 / ESA Copernicus).
