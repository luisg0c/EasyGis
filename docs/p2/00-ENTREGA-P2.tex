...
Modificabilidade & 3/5 & Adicionar índice novo exige tocar \texttt{main.py}; cobertura de testes (55\% no \textit{core}) protege & Refatorar para \textit{registry pattern}: \texttt{INDEX\_HANDLERS = \{"NDVI": \dots\}}\\
